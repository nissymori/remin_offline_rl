...
class ReBRACReMinDetAgent(flax.struct.PyTreeNode):
    """ReBRAC with action-sampled ReMin actor optimization."""
    ...
    def actor_loss(self, batch, grad_params, rng):
        """Compute the ReBRAC actor loss with ReMin over action retries."""
